...
- The desktop and family-sharing controls must not be submitted to App Review as production-ready until the CadetCatch access API endpoints are deployed, StoreKit server verification is configured, tester access is verified, and this reviewer note is updated.
