...
function makeVoicemailScript(row) {
  ...
  return [
    ...
    'If you want the full build tailored and hosted, the first 12 months of EB28 Growth Hosting are $1,176 paid upfront ($98/month). Website-only is $800 one-time.',
...
function makeBookingAskMessage(row) {
  ...
  return [
    ...
    routeLine,
    '',
    'The website build is included when you prepay $1,176 for the first 12 months of EB28 Growth Hosting ($98/month), including hosting, maintenance, SEO upkeep, and one weekly local blog or Google Business content prompt. Website-only is $800 one-time.',
    '',
...
async function writeCallFormSprint(callRows) {
  ...
  const lines = [
    ...
    '',
    '```text',
    'Hi, this is Rich with EB28. I prepared an owner-review website direction for your business. It is not public-indexed and it is not your official website. I wanted to get it to the owner or manager who handles the website. The website build is included with $1,176 upfront for the first 12 months of Growth Hosting ($98/month), or the website-only build is $800 one-time. Who is the best person to review it?',
    '```',
    '',
    ...blocks,
  ];
